...
import { Flag, Trophy, Coffee, Shield, FileText, Camera, MessageCircle, PlayCircle, Lock, ShieldCheck, Activity, Wifi, Cpu, X } from 'lucide-react';
...
const footerLinks = [
  {
    ...
    links: [
      ...
      { label: 'The Paddock', href: '/paddock', icon: Trophy },
        ...
        <div className="border-t border-white/5 pt-8 flex flex-col md:flex-row justify-between items-center gap-6">
          <div className="flex items-center gap-4">
            <motion.div
              ...
              className="w-2 h-2 rounded-full bg-racing-red animate-pulse"
            />
            <p className="font-orbitron text-[9px] text-white/20 tracking-[0.3em] uppercase">
              © 2026 Apex Brews SRL · All rights reserved
            </p>
          </div>

          {/* Secure stripe badge / indicators */}
          <div className="flex flex-wrap items-center gap-6">
            ...
            {/* Premium Stripe telemetry gateway badge */}
            <button
              onClick={handleOpenTelemetry}
              className="flex items-center gap-3.5 bg-white/3 hover:bg-white/5 border border-white/5 hover:border-racing-red/20 px-4 py-2 rounded-xl transition-all duration-300 group cursor-pointer"
            >
